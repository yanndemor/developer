...
const SkillsTabs = () => {
  ...
  return (
    <div className="d-flex align-items-start mx-1">
      <div className="nav flex-column nav-pills me-1" id="v-pills-tab" role="tablist" aria-orientation="vertical">
      ...
      <div className="tab-content " id="v-pills-tabContent">
        ...
        <div className="tab-pane fade" id="v-pills-developerSkills" role="tabpanel" aria-labelledby="v-pills-developerSkills-tab">...</div>
