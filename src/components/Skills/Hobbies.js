...
const Hobbies = () => {
  ...
  <>
    ...
    <div className="container ">
       <div className="row d-flex flex-column flex-lg-row align-items-center my-5 ">
        <h4 className="title-hobby">Surfing<span className="line-title"></span></h4>
          ...
          <div className="col  image-bg-golf">
              <img className=" float-start image-hobbies" src={surf} alt="photo surf"/>

          </div>
        </div>
        <Divider/>
        <div className="row d-flex flex-column flex-lg-row align-items-center my-5 ">
        <h4 className="title-hobby">Golf<span className="line-title"></span></h4>
          <div className="col   image-bg-surf">
            <img className="float-end image-hobbies" src={golf} alt="photo golf"/>
          </div>
        ...
        <Divider/>
        <div className="row d-flex flex-column flex-lg-row align-items-center my-5">
        <h4 className="title-hobby">RockClimbing<span className="line-title"></span></h4>
        <div className="col descriptiion-hobby">
          ...
          <div className="col   image-bg-rockClimbing">
            <img className="float-start image-hobbies"src={rockClimbing} alt="photo escalade"/>
          </div>
        </div>
        <Divider/>
        <div className="row d-flex flex-column flex-lg-row align-items-center my-5 ">
        <h4 className="title-hobby">Baseball<span className="line-title"></span></h4>
          <div className="col  image-bg-baseball">
            <img className="float-end image-hobbies" src={baseball} alt="photo baseball"/>
          </div>
